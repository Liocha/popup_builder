 ...
 */
 export function isComponent(domNode) {
  ...
  /**
   * Просто инкапсулируйте некоторые события взаимодействия с мышью
   */
  export class Interaction {
    /**
     * Узел dom, которому нужно добавить события
     * @type {HTMLElement}
     */
    element = null
    // шаг движения мыши
    ...
    // Переместите мышь в положение нажатой точки
    x = 0
    y = 0
