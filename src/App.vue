<script lang="jsx">
import ComponentsVue from "@/components/Componets.vue";
import EditorViewVue from "@/components/EditorView.vue";
import {
...
import PropInspectorVue from '@/components/PropInspector.vue'
import PluginSelectionVue from '@/plugins/plugin-selection.vue'
import PluginGridVue from '@/plugins/plugin-grid.vue'
import { registerKeyboardAction } from '@/plugins/keyboard.js'
let historys = [[]]
...
export default {
  ...
  data() {
    return {
      controls: [], //набор элементов -> массив объектов
